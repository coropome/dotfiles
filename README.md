...
macOS-first の AI workspace platform。AI workflow と starter repo onboarding を主役にしつつ、shell / tmux / git / bootstrap は host substrate として同じ runtime repo に同梱している。
