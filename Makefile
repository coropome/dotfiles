...
help:
	...
	@echo ""
	@echo "Quickstart: make install && open a new terminal && ai start"
...
agent:
	...
	while IFS= read -r pkg || [ -n "$$pkg" ]; do \
		...
		echo "==> Installing $$pkg..."; \
		brew install "$$pkg"; \
	done < manifests/packages/agent-brew.txt; \
	...
	done < manifests/packages/agent-cask.txt
...
test:
	...
	./test/ai_trust.sh
	./test/demo_assets.sh
	./test/github_actions_starter.sh
