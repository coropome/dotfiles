...
assert_contains "$pr_workflow" "Current default shared AI Dev OS runtime source."
...
assert_contains "$pr_workflow" "name: Checkout shared AI Dev OS runtime"
...
assert_contains "$hosted_workflow" "Current default shared AI Dev OS runtime source."
assert_contains "$hosted_workflow" "AI_DEV_OS_RUNTIME_REF: main"
assert_contains "$hosted_workflow" "name: Checkout shared AI Dev OS runtime"
